...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { avatar: @sponsor.avatar, description: @sponsor.description, title: @sponsor.title, url: @sponsor.url }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { avatar: @sponsor.avatar, description: @sponsor.description, title: @sponsor.title, url: @sponsor.url }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
